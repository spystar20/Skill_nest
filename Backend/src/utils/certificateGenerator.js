...
const certificatePath = path.resolve('../Frontend/src/assets/certificate.png')
...
const badgePng = `data:image/png;base64,${fs.readFileSync(badgePath).toString('base64')}`
const certificatePng = `data:image/png;base64,${fs.readFileSync(certificatePath).toString('base64')}`
const html = `
<!DOCTYPE html>
<html>
<head>
...
padding: 12px;
background:
radial-gradient(circle at 20% 15%,rgba(170,210,235,0.45),transparent 30%),
radial-gradient(circle at 75% 70%,rgba(220,235,245,0.5),transparent 35%),
repeating-linear-gradient(90deg,rgba(70,100,120,0.07) 0 1px,transparent 1px 50px),
repeating-linear-gradient(0deg,rgba(70,100,120,0.07) 0 1px,transparent 1px 50px);
...
padding: 24px;
background:
radial-gradient(circle at 80% 55%,rgba(147,197,253,0.55),transparent 45%),
#f5faff;
}
.content {
position: relative;
...
<img src="${certificatePng}" class="certificate-decoration" alt="Certificate decoration" />
<div class="inner-certificate">
<div class="content">
<div class="logo">
<div class="logo-icon">◆</div>
<div class="logo-text">Skill<span>nest</span></div>
...
<img src="${badgePng}" class="badge" alt="Certificate badge" />
</div>
