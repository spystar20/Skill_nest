...
const DashboardStat = ({ title, icon, growth, dataValue }) => {
  return (
    <div className='border border-[#E5E7EB] bg-white shadow-sm rounded-lg p-2 md:p-4 flex flex-col gap-3'>
      <div className='flex gap-2.5 items-center text-[#111827]'>
        ...
        <h6 className='md:text-base md:font-semibold font-medium text-sm' style={{ fontFamily: 'Outfit, sans-serif' }}>
          {title}
        </h6>
      </div>
