...
import { useDeleteResources, useUpdateUploadedResources } from '@/hooks/CoursesHooks/courseMutation';
const ResourcesTab = ({ lessonId, sectionId }) => {
  const { user } = useAuth()
  ...
  const { mutate: resourceMutate } = useUpdateUploadedResources()
  ...
  // resource uploading api
  const handleUpload = () => {
    resourceMutate({ resourceForm, lessonId }, {
      onSuccess: () => {
  ...
  // resource deleting api 
  const handleDelete = (resourceId) => {
    deleteResource({ resourceId, lessonId, sectionId }, {
      onSuccess: () => {
