        ...
        <div className='flex flex-col items-center justify-center'>
          <div className=' md:max-w-xl flex flex-col md:p-12 font-body'>
            ...
            <div className='flex flex-col md:gap-4 md:py-4 '>
              <h2 className='font-semibold text-2xl md:text-3xl text-slate-900 font-body capitalize'>Set new <span className='italic text-transparent bg-clip-text  bg-gradient-to-br from-[#728ccd] to-[#364c84] font-[Merienda] '>  password </span> </h2>
