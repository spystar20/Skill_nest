...
const Sidebar = () => {
  return (
    <div className='min-h-screen hidden bg-[#0a1931] w-64  fixed left-0 top-0 backdrop-blur-lg  bg-opacity-40 text-white md:flex flex-col justify-between '>
        <div>
...
<div className='flex items-center justify-start gap-2 text-lg px-3 p-1 mb-4 hover:translate-x-1 hover:bg-neutral-200 hover:text-[#0a1931] rounded-l-full transition-all duration-200 ease-in cursor-pointer '><IoLogOutSharp className='w-5 h-5'/><span>Logout</span></div>
